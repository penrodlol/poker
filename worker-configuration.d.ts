/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6645ef5ff7a3bf0a920389660da8bb38)
// Runtime types generated with workerd@1.20260831.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_D1_ID: string;
	CLOUDFLARE_API_ACCESS_TOKEN: string;
	VITE_DISCORD_CLIENT_ID: string;
	VITE_DISCORD_CLIENT_SCOPES: string;
	VITE_DISCORD_CDN_URL: string;
	DISCORD_CLIENT_SECRET: string;
	DISCORD_FRAME_ANCESTORS: string;
	DISCORD_OAUTH_TOKEN_URL: string;
	GameChannelDurableObject: DurableObjectNamespace<import("./src/server/index").GameChannelDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "GameChannelDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_D1_ID" | "CLOUDFLARE_API_ACCESS_TOKEN" | "VITE_DISCORD_CLIENT_ID" | "VITE_DISCORD_CLIENT_SCOPES" | "VITE_DISCORD_CDN_URL" | "DISCORD_CLIENT_SECRET" | "DISCORD_FRAME_ANCESTORS" | "DISCORD_OAUTH_TOKEN_URL">> {}
}
